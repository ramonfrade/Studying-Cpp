...
int main()
try {
        cout << "Enter a Celsius or Kelvin temperature and I will convert to the other. (enter the temperature followed by 'c' for Celsius and 'k' for Kelvin) \n";
        ...
        case 'k':
            ...
            break;
        default:
            error("invalid temperature! type 'c' or 'k'");
            break;
        }                            
}
catch(exception& e){
