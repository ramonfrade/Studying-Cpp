...
namespace Graph_lib
{
    ...
    {
        static const QMap<Line_style, Qt::PenStyle> line_style_map = {{Line_style::none, Qt::NoPen},
    ...
    void WindowPrivate::paintEvent(QPaintEvent* /*event*/)
    {
        ...
        for(auto&& shape : shapes) { shape->draw(shape_painter); }
    }
    ...
    void WindowPrivate::timer_wait(int milliseconds, std::function<void()> cb)
    {
        ...
        *conn = QObject::connect(&user_timer,
                                 &QTimer::timeout,
