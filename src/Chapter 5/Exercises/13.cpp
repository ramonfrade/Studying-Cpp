...
try
{
    ...
    // playing the game
    cout << "Enter a sequence of 4 different integers in the range 0 to 9: (e.g., 1234 but not 1122) (type 'q' if you "
            "want to give up)\n";
    while(cin >> x)
    {
        if(x > 9999 || x < 0)
        ...
        if(correct == true)
        {
            ...
            answer = new_answer();
            cout << "Enter a sequence of 4 different integers in the range 0 to 9: (e.g., 1234 but not 1122) (type 'q' "
