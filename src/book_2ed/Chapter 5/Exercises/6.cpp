...
try
{
    cout << "Enter a Celsius or Fahrenheit temperature and I will convert to the other. (enter the temperature "
            "followed by 'c' for Celsius and 'f' for Fahrenheit) \n";
    ...
    switch(temp)
    {
        ...
        case 'f':
            ...
            break;
        default: error("invalid temperature! type 'c' or 'f'"); break;
    }
}
catch(exception& e)
{
