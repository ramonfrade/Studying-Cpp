...
try
{
    Book Flu{"7-7-0-5", "Fluminense", "Oscar Cox", Date{1902, Month::jul, 21}, Genre::bibliography};
    Book Flu2 = Flu;
    cout << Flu;
    if(Flu == Flu2)
    {
    ...
    Book NotFlu{"7-7-7-7", "Fluminense", "Oscar Cox", Date{1902, Month::jul, 21}, Genre::bibliography};
    if(NotFlu != Flu)
    {
        cout << "Not equal\n";
    }
